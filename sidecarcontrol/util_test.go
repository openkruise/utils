	...
	cases := []struct {
		...
		},
		{
			...
			getPod: func() *corev1.Pod {
				...
				control.UpdatePodAnnotationsInUpgrade([]string{"cold-sidecar"}, pod, sidecarSet)
				return pod
			},
			upgradeSidecars: func() (sets.String, sets.String) {
				return sets.NewString(sidecarSetDemo.Name), sets.NewString("cold-sidecar", "hot-sidecar-1", "hot-sidecar-2")
		...
		},
		{
			...
			getPod: func() *corev1.Pod {
				...
				control.UpdatePodAnnotationsInUpgrade([]string{"hot-sidecar-2"}, pod, sidecarSet)
				return pod
			},
			upgradeSidecars: func() (sets.String, sets.String) {
				return sets.NewString(sidecarSetDemo.Name), sets.NewString("cold-sidecar", "hot-sidecar-1", "hot-sidecar-2")
		...
		},
		{
			...
			getPod: func() *corev1.Pod {
				...
				control.UpdatePodAnnotationsInUpgrade([]string{"hot-sidecar-1"}, pod, sidecarSet)
				return pod
			},
			upgradeSidecars: func() (sets.String, sets.String) {
				return sets.NewString(sidecarSetDemo.Name), sets.NewString("cold-sidecar", "hot-sidecar-1", "hot-sidecar-2")
